...
export const RED_FLAGS = {
  EMERGENCY: {
    keywords: [
      ...
      "swollen jaw can't open mouth", "jaw swelling closing throat", "abscess spreading to neck",
      "eye popped out", "chemical in eye", "penetrating eye injury",
      "avulsed tooth", "tooth knocked out", "tooth pushed into jaw",
      "severe dental infection spreading", "facial swelling closing airway",
      "seizure", "convulsing", "status epilepticus",
      "stroke symptoms", "sudden paralysis", "sudden vision loss",
      "can't feel legs", "can't move legs", "paralyzed",
    ],
    triageKeywords: [
  ...
  URGENT: {
    keywords: [
      ...
      "toothache severe", "dental pain can't sleep", "swollen gum with fever",
      "broken tooth bleeding", "lost filling exposed nerve", "broken crown sharp edge",
      "dry socket", "extraction site pain after days",
      "ear pain with fever", "ear drainage blood", "sudden hearing loss",
      "nosebleed won't stop", "sinus pain with high fever",
      "eye pain with nausea", "sudden blurry vision", "new floaters with flashes",
      "severe sore throat can't swallow", "muffled voice drooling",
      "neck lump growing fast", "thyroid nodule rapid growth",
      "neuropathy burning feet", "new numbness spreading",
      "hypoglycemia confused", "diabetic ketoacidosis", "insulin pump malfunction",
      "severe asthma attack", "can't speak full sentences", "oxygen saturation low",
      "seizure first time", "postictal confusion",
      "suicidal ideation", "self-harm fresh cuts", "hearing voices",
      "pet not eating days", "pet collapsed", "pet seizuring",
      "pet bleeding won't stop", "pet choking", "pet blue gums",
      "pet can't stand", "pet dragging legs", "pet bloated abdomen",
      "pet hit by car", "pet toxin ingestion", "pet heatstroke",
      "pet eye injury", "pet severe vomiting days", "pet not drinking",
    ],
  },
  CRISIS: {
    keywords: [
