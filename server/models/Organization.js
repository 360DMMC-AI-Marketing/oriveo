...
const organizationSchema = new mongoose.Schema({
  ...
  businessHours: {
    ...
    days: {
      ...
      sat: { open: { type: String, default: "09:00" }, close: { type: String, default: "13:00" }, closed: { type: Boolean, default: true } },
      sun: { open: { type: String, default: "09:00" }, close: { type: String, default: "13:00" }, closed: { type: Boolean, default: true } },
    },
    afterHoursAction: { type: String, enum: ["transfer", "take-message"], default: "take-message" },
