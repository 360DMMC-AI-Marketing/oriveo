...
export async function handleInboundMediaStream(ws, req) {
  ...
  const agent = createVoiceAgent({
    ...
    patientInfo: "",
    practiceName,
    businessHours: call.organization?.businessHours || null,
    afterHoursAction: call.organization?.businessHours?.afterHoursAction || "take-message",
    afterHoursTransferNumber: call.organization?.businessHours?.transferNumber || "",
    afterHoursClosedMessage: call.organization?.businessHours?.closedMessage || "",
    triageEngine,
    emotionAnalyzer,
