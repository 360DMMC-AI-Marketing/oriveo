...
const sections = [
  ...
  },
  {
    ...
    steps: [
      ...
      "PHI (Protected Health Information) is encrypted at rest in the database.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Appointments can also be created by the AI voice agent during patient calls.",
    ],
  },
  {
    icon: Megaphone,
  ...
  },
  {
    ...
    steps: [
      ...
      "Red flag keyword tags are shown in the call detail panel for quick scanning.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Call outcome donut chart visualizes completed vs failed vs in-progress vs scheduled.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Useful for supervisors to oversee call quality and intervene if needed.",
    ],
  },
  {
    icon: Bell,
    ...
    steps: [
      ...
      "Notification types include: emergency alerts, high severity calls, inbound calls, call failures, transfer notices, and follow-up needs.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Emergency call uses Twilio to call the configured emergency number or 911.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Transferred calls are shown with a 'transferred' badge in Inbound Calls and Call Review lists.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Appointment stats are updated in real time — no manual entry needed.",
    ],
  },
  {
    icon: Building2,
    ...
    steps: [
      ...
      "Connected Services badges at the top show which integrations are active/inactive at a glance.",
    ],
  },
  {
    icon: Mail,
    ...
    steps: [
      ...
      "Monthly Analytics Report is automatically emailed to the clinic admin on the 1st of each month with call stats, appointment stats, and active patient/staff counts.",
      "Clinic working hours are configurable (days of week, start/end times, slot duration) — contact your admin to set up.",
    ],
  },
  {
    icon: UserPlus,
    ...
    steps: [
      ...
      "Users can update their own profile (name, phone, specialty, language) from their account settings.",
    ],
  },
  {
    icon: ScrollText,
    ...
    steps: [
      "Only admins can access the Audit Log — visible in the sidebar under Administration.",
      "Every patient view, call access, setting change, and EHR sync is automatically logged with user, timestamp, and IP.",
      "Filter events by action type (Patient Viewed, Call Transferred, EHR Synced, etc.) using the dropdown.",
      "Select time range: 24h, 7 days, 30 days, or 90 days for quick filtering.",
      "Summary cards at the top show the most frequent event types for quick oversight.",
      "Use pagination to browse through large volumes of audit history.",
